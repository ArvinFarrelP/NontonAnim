...
.then(data => {
    ...
    refererDiv.innerHTML = `<h2> Watching ${anime.title} Episode ${no}</h2>  <iframe scrolling="no" frameBorder="0" allowfullscreen = "true" height="580" width="1000" src="//9anime.skin/stream/play.php?slug=${anime.id}-episode-${no}" </iframe> <p></p>`
